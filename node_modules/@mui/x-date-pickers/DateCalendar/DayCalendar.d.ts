...
import { PickersDayProps, ExportedPickersDayProps } from '@mui/x-date-pickers/PickersDay/PickersDay';
...
import { DefaultizedProps, SlotComponentPropsFromProps } from '@mui/x-date-pickers/internals/models/helpers';
