...
import { DateRangeValidationError, DateRange } from '@mui/x-date-pickers-pro/models';
...
import { DateRangePickerToolbarProps, ExportedDateRangePickerToolbarProps } from '@mui/x-date-pickers-pro/DateRangePicker/DateRangePickerToolbar';
