...
import { UseDesktopRangePickerParams, UseDesktopRangePickerProps } from '@mui/x-date-pickers-pro/internals/hooks/useDesktopRangePicker/useDesktopRangePicker.types';
