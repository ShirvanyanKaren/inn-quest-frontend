...
import { UseStaticRangePickerParams, UseStaticRangePickerProps } from '@mui/x-date-pickers-pro/internals/hooks/useStaticRangePicker/useStaticRangePicker.types';
/**
